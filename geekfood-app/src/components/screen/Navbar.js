...
function Navbar(){
    return(
        <div className="navbar"> 
            <div className="logo"><svg width="32" height="33" viewBox="0 0 32 33" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<span className="logo-name">GeekFoods</span>
    ...
    <div>
        <ul style={{ listStyleType: 'none' }} className="nav-contents">
            <li>Home</li>
            <li>Quote</li>
            <li>Resturants</li>
            <li>Foods</li>
    ...
    <div>
<Button fontSize={".875rem"} fontWeight={"500"} padding={"0.5rem 1rem"} fontColor={"#fff"} backgroundColor={"#1d4ed8"} borderRadius={"8px"} >Get started</Button>
    </div>
        </div>
    )
}
